# Generated by Powerlevel10k configuration wizard on 2021-11-12 at 14:24 EST.
...
# Connect left prompt lines with these symbols. You'll probably want to use the same color
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n%253F@%2F%m %7Fin'
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
  typeset -g POWERLEVEL9K_WIFI_FOREGROUND=14
  # Custom icon.
